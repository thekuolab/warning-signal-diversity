...
for (i in 1:10){
  ...
  dir<-paste0("D:/Desktop/PTO_100_1/",i)
  ...
  clusterExport(clust,"mimic_social_fast_pto")
  ...
  parApply(cl = clust,parameter_space,1,function(y){mimic_social_fast_pto(G = G,P_OLD = 0.5,Abundance = c(200,y[1]),
                                                                 lambda_L = c(y[3],y[3]),alpha_F = y[4],baby = y[5],
                                                                 K = c(200,y[2]),social_spread = social_spread,social_efficacy = social_efficacy,
                                                                 inter_learning = TRUE,
                                                                 GenTime = 100,GenTime_P = 100,turnover = 20,timestep = 50000)})
...
files<-list.files("D:/Desktop/separate K/1_incomplete")

combos<-NULL

for (i in 1:nrow(parameter_space)){
  
  combos[i]<-(paste0("rare",parameter_space[i,1],"_K2",parameter_space[i,2],"_P",round(parameter_space[i,3],3),"_F",round(parameter_space[i,4],3),"_baby_",parameter_space[i,5],"_sspr_",social_spread,"_seff_",social_efficacy,".csv"))
...
for (i in 1:length(missing)){
  ...
  parameter_space_missing[i,2]<-as.numeric(str_split(str_split(missing[i],pattern = "_")[[1]][2],pattern = "K2")[[1]][2])
...
parApply(cl = clust,parameter_space_missing,1,function(y){mimic_social_fast_pto(G = G,P_OLD = 0.5,Abundance = c(200,y[1]),
                                                                             lambda_L = c(y[3],y[3]),alpha_F = y[4],baby = y[5],
                                                                             K =c(200,y[2]),social_spread = social_spread,social_efficacy = social_efficacy,
                                                                             inter_learning = TRUE,
                                                                             GenTime = 100,GenTime_P = 1000,timestep = 50000)})
...
for (j in 1:10){
  ...
  # social learning
  dir<-paste0("D:/Desktop/PTO_100_1/",replication)
  ...
  dir2<-paste0("G:/我的雲端硬碟/Projects/Predator learning and warning signal diversity/PTO_100_1")
...
df<-read_csv(files[i])
df$selection_NEW<-(df$abnc_NEW_final/df$x2_0)/(df$abnc_OLD_final/200)-1
df[is.na(df$selection_NEW)==TRUE,]$selection_NEW<-0

write_csv(df,paste0(i,".csv"))
...
# predator turnover
setwd("~/Library/CloudStorage/GoogleDrive-kuochiyun@gmail.com/My Drive/Projects/Predator learning and warning signal diversity/PTO_100_1")
...
# Predator turnover
write_csv(summary,"~/Library/CloudStorage/GoogleDrive-kuochiyun@gmail.com/My Drive/Projects/Predator learning and warning signal diversity/PTO_100_1/summary_PTO_100_1.csv")
...
# outcome
  sepK_outcome_G0_r0.2<-ggplot(subset(df_plot,subset = r==0.2 & G ==0 &priority %in% c("A","C","E")),aes(x = lambda,y = alphaF,fill=outcome))+
    ...
    theme(legend.position = "",strip.background = element_blank(),strip.text.x = element_blank())+
    labs(x = "",y = "")+
...
# selection
  sepK_sel_G0_r0.2<-ggplot(subset(df_plot,subset = r==0.2 & G==0 & priority %in% c("A","C","E")),aes(x = lambda,y = alphaF,fill=round(selection_NEW,3)))+
    ...
    theme_bw()+
    mdthemes::md_theme_bw()+
    theme(legend.position = "right",strip.background = element_blank(),strip.text.x = element_blank())+
    labs(x = "",y = "")+
...
sepK_G0_imb<-read_csv("/Users/chi/Library/CloudStorage/GoogleDrive-kuochiyun@gmail.com/My Drive/Projects/Predator learning and warning signal diversity/social_perennialprey/separate K/summary_G0.csv")
sepK_G0.5_imb<-read_csv("/Users/chi/Library/CloudStorage/GoogleDrive-kuochiyun@gmail.com/My Drive/Projects/Predator learning and warning signal diversity/social_perennialprey/separate K/summary_G0.5.csv")
sepK_social_imb<-read_csv("/Users/chi/Library/CloudStorage/GoogleDrive-kuochiyun@gmail.com/My Drive/Projects/Predator learning and warning signal diversity/social_perennialprey/separate K/summary_social.csv")

sharedK_G0_imb<-read_csv("/Users/chi/Library/CloudStorage/GoogleDrive-kuochiyun@gmail.com/My Drive/Projects/Predator learning and warning signal diversity/social_perennialprey/shared K/summary_G0.csv")
sharedK_G0.5_imb<-read_csv(paste0("/Users/chi/Library/CloudStorage/GoogleDrive-kuochiyun@gmail.com/My Drive/Projects/Predator learning and warning signal diversity/social_perennialprey/shared K/summary_G0.5.csv"))
sharedK_social_imb<-read_csv(paste0("/Users/chi/Library/CloudStorage/GoogleDrive-kuochiyun@gmail.com/My Drive/Projects/Predator learning and warning signal diversity/social_perennialprey/shared K/summary_social.csv"))

# New fig 2: IMB w/o prey competition
sepK_x2_20_imb<-ggplot(subset(sepK_G0_imb,subset = r==0.2 & x2_0==20 & K2==20),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
...
sepK_x2_100_imb<-ggplot(subset(sepK_G0_imb,subset = r==0.2 & x2_0==100 & K2==100),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank(),axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
  scale_fill_gradient2(low = "black",mid = "red",high = "blue",midpoint = 1)

sepK_x2_180_imb<-ggplot(subset(sepK_G0_imb,subset = r==0.2 & x2_0==180 & K2==180),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank(),axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
sepK_x2_20_G0.5_imb<-ggplot(subset(sepK_G0.5_imb,subset = r==0.2 & x2_0==20 & K2==20),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank())+
  labs(x = "",y = paste0(""))+
...
sepK_x2_100_G0.5_imb<-ggplot(subset(sepK_G0.5_imb,subset = r==0.2 & x2_0==100 & K2==100),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank(),axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
sepK_x2_180_G0.5_imb<-ggplot(subset(sepK_G0.5_imb,subset = r==0.2 & x2_0==180 & K2==180),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank(),axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
sepK_x2_20_social_imb<-ggplot(subset(sepK_social_imb,subset = r==0.2 & x2_0==20 & K2==20),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "")+
  labs(x = "",y = paste0(""))+
...
sepK_x2_100_social_imb<-ggplot(subset(sepK_social_imb,subset = r==0.2 & x2_0==100 & K2==100),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
...
sepK_x2_180_social_imb<-ggplot(subset(sepK_social_imb,subset = r==0.2 & x2_0==180 & K2==180),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
gridExtra::grid.arrange(sepK_x2_20_imb,sepK_x2_100_imb,sepK_x2_180_imb,
                        sepK_x2_20_G0.5_imb,sepK_x2_100_G0.5_imb,sepK_x2_180_G0.5_imb,
                        sepK_x2_20_social_imb,sepK_x2_100_social_imb,sepK_x2_180_social_imb,ncol=3)


# New fig 3: IMB w/ prey competition
sharedK_x2_20_imb<-ggplot(subset(sharedK_G0_imb,subset = r==0.2 & x2_0==20 & K==220),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank())+
  labs(x = "",y = paste0(""))+
...
sharedK_x2_100_imb<-ggplot(subset(sharedK_G0_imb,subset = r==0.2 & x2_0==100 & K==300),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank(),axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
sharedK_x2_180_imb<-ggplot(subset(sharedK_G0_imb,subset = r==0.2 & x2_0==180 & K==380),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank(),axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
sharedK_x2_20_G0.5_imb<-ggplot(subset(sharedK_G0.5_imb,subset = r==0.2 & x2_0==20 & K==220),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank())+
  labs(x = "",y = paste0(""))+
...
sharedK_x2_100_G0.5_imb<-ggplot(subset(sharedK_G0.5_imb,subset = r==0.2 & x2_0==100 & K==300),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank(),axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
sharedK_x2_180_G0.5_imb<-ggplot(subset(sharedK_G0.5_imb,subset = r==0.2 & x2_0==180 & K==380),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank(),axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
sharedK_x2_20_social_imb<-ggplot(subset(sharedK_social_imb,subset = r==0.2 & x2_0==20 & K==220),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "")+
  labs(x = "",y = paste0(""))+
...
sharedK_x2_100_social_imb<-ggplot(subset(sharedK_social_imb,subset = r==0.2 & x2_0==100 & K==300),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
sharedK_x2_180_social_imb<-ggplot(subset(sharedK_social_imb,subset = r==0.2 & x2_0==180 & K==380),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
gridExtra::grid.arrange(sharedK_x2_20_imb,sharedK_x2_100_imb,sharedK_x2_180_imb,
                        sharedK_x2_20_G0.5_imb,sharedK_x2_100_G0.5_imb,sharedK_x2_180_G0.5_imb,
                        sharedK_x2_20_social_imb,sharedK_x2_100_social_imb,sharedK_x2_180_social_imb,ncol=3)


# Fig SX: Predator turnover
pto_100_0.1<-read_csv("/Users/chi/Library/CloudStorage/GoogleDrive-kuochiyun@gmail.com/My Drive/Projects/Predator learning and warning signal diversity/social_perennialprey/PTO/summary_PTO_100_0.1.csv")
pto_100_1<-read_csv("/Users/chi/Library/CloudStorage/GoogleDrive-kuochiyun@gmail.com/My Drive/Projects/Predator learning and warning signal diversity/social_perennialprey/PTO/summary_PTO_100_1.csv")
pto_1000_0.1<-read_csv("/Users/chi/Library/CloudStorage/GoogleDrive-kuochiyun@gmail.com/My Drive/Projects/Predator learning and warning signal diversity/social_perennialprey/PTO/summary_PTO_1000_0.1.csv")  
pto_1000_1<-read_csv("/Users/chi/Library/CloudStorage/GoogleDrive-kuochiyun@gmail.com/My Drive/Projects/Predator learning and warning signal diversity/social_perennialprey/PTO/summary_PTO_1000_1.csv")  

sepK_x2_20_pto_1000_0.1<-ggplot(subset(pto_1000_0.1,subset = r==0.2 & x2_0==20 & K2==20),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank())+
  labs(x = "",y = paste0(""))+
...
sepK_x2_100_pto_1000_0.1<-ggplot(subset(pto_1000_0.1,subset = r==0.2 & x2_0==100 & K2==100),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank(),axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
sepK_x2_180_pto_1000_0.1<-ggplot(subset(pto_1000_0.1,subset = r==0.2 & x2_0==180 & K2==180),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank(),axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
sepK_x2_20_pto_1000_1<-ggplot(subset(pto_1000_1,subset = r==0.2 & x2_0==20 & K2==20),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank())+
  labs(x = "",y = paste0(""))+
...
sepK_x2_100_pto_1000_1<-ggplot(subset(pto_1000_1,subset = r==0.2 & x2_0==100 & K2==100),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank(),axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
sepK_x2_180_pto_1000_1<-ggplot(subset(pto_1000_1,subset = r==0.2 & x2_0==180 & K2==180),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank(),axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
sepK_x2_20_pto_100_0.1<-ggplot(subset(pto_100_0.1,subset = r==0.2 & x2_0==20 & K2==20),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank())+
  labs(x = "",y = paste0(""))+
...
sepK_x2_100_pto_100_0.1<-ggplot(subset(pto_100_0.1,subset = r==0.2 & x2_0==100 & K2==100),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank(),axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
sepK_x2_180_pto_100_0.1<-ggplot(subset(pto_100_0.1,subset = r==0.2 & x2_0==180 & K2==180),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.x = element_blank(),axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
sepK_x2_20_pto_100_1<-ggplot(subset(pto_100_1,subset = r==0.2 & x2_0==20 & K2==20),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "")+
  labs(x = "",y = paste0(""))+
...
sepK_x2_100_pto_100_1<-ggplot(subset(pto_100_1,subset = r==0.2 & x2_0==100 & K2==100),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
sepK_x2_180_pto_100_1<-ggplot(subset(pto_100_1,subset = r==0.2 & x2_0==180 & K2==180),aes(x = lambda,y = alphaF,fill=outcome))+
  geom_raster()+
  theme_bw()+
  theme(legend.position = "",axis.text.y = element_blank())+
  labs(x = "",y = paste0(""))+
...
gridExtra::grid.arrange(sepK_x2_20_imb,sepK_x2_100_imb,sepK_x2_180_imb,
                        sepK_x2_20_pto_1000_0.1,sepK_x2_100_pto_1000_0.1,sepK_x2_180_pto_1000_0.1,
                        sepK_x2_20_pto_1000_1,sepK_x2_100_pto_1000_1,sepK_x2_180_pto_1000_1,
                        sepK_x2_20_pto_100_0.1,sepK_x2_100_pto_100_0.1,sepK_x2_180_pto_100_0.1,
                        sepK_x2_20_pto_100_1,sepK_x2_100_pto_100_1,sepK_x2_180_pto_100_1,nrow=5)  
